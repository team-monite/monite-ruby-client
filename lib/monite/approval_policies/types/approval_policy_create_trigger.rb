...
#  specifies the event that will trigger the policy to be evaluated.
    class ApprovalPolicyCreateTrigger


# Deserialize a JSON object to an instance of ApprovalPolicyCreateTrigger
      #
      # @param json_object [String] 
      # @return [Monite::ApprovalPolicies::ApprovalPolicyCreateTrigger]

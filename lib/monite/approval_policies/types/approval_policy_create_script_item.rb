...
module Monite
  module ApprovalPolicies
    class ApprovalPolicyCreateScriptItem


# Deserialize a JSON object to an instance of ApprovalPolicyCreateScriptItem
      #
      # @param json_object [String] 
      # @return [Monite::ApprovalPolicies::ApprovalPolicyCreateScriptItem]

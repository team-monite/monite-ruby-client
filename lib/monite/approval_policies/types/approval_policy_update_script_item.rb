...
module Monite
  module ApprovalPolicies
    class ApprovalPolicyUpdateScriptItem


# Deserialize a JSON object to an instance of ApprovalPolicyUpdateScriptItem
      #
      # @param json_object [String] 
      # @return [Monite::ApprovalPolicies::ApprovalPolicyUpdateScriptItem]

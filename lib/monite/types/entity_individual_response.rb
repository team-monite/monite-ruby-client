...
require_relative "individual_response_schema"
...
module Monite
  class EntityIndividualResponse
  ...
  # @return [String] An official email address of the entity
    attr_reader :email
  # @return [Monite::IndividualResponseSchema] A set of metadata describing an individual
...
#  for entities that are non-VAT registered.
  ...
  # @return [Object] 
    ...
    # @param individual [Monite::IndividualResponseSchema] A set of metadata describing an individual
...
#  for entities that are non-VAT registered.
    ...
    # @return [Monite::EntityIndividualResponse]
...
# Deserialize a JSON object to an instance of EntityIndividualResponse
    #
  ...
  nil
      ...
      unless parsed_json["individual"].nil?
        ...
        individual = Monite::IndividualResponseSchema.from_json(json_object: individual)
      else
        individual = nil
      end
...
# Serialize an instance of EntityIndividualResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Monite::IndividualResponseSchema.validate_raw(obj: obj.individual)

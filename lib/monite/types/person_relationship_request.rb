...
module Monite
  class PersonRelationshipRequest
...
#  the organization
    ...
    # @return [Monite::PersonRelationshipRequest]
...
# Deserialize a JSON object to an instance of PersonRelationshipRequest
    #
...
# Serialize an instance of PersonRelationshipRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  ...
  # @return [Object] 
    ...
    # @return [Monite::PaymentsSettingsOutput]
...
# Deserialize a JSON object to an instance of PaymentsSettingsOutput
    #
...
# Serialize an instance of PaymentsSettingsOutput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

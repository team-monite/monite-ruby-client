...
# A schema represents address info of the entity
  class EntityAddressResponseSchema
  ...
  # @return [Object] 
    ...
    # @return [Monite::EntityAddressResponseSchema]
...
# Deserialize a JSON object to an instance of EntityAddressResponseSchema
    #
...
# Serialize an instance of EntityAddressResponseSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  class OptionalPersonAddressRequest
  # @return [String] City, district, suburb, town, or village
    attr_reader :city
  # @return [Monite::AllowedCountries] Two-letter country code (ISO 3166-1 alpha-2)
    attr_reader :country
  # @return [String] Address line 1 (e.g., street, PO Box, or company name)
    attr_reader :line_1
  # @return [String] Address line 2 (e.g., apartment, suite, unit, or building)
    attr_reader :line_2
  # @return [String] ZIP or postal code
    attr_reader :postal_code
  # @return [String] State, county, province, or region
    attr_reader :state
  ...
  # @return [Object] 
    ...
    # @param country [Monite::AllowedCountries] Two-letter country code (ISO 3166-1 alpha-2)
    # @param line_1 [String] Address line 1 (e.g., street, PO Box, or company name)
    # @param line_2 [String] Address line 2 (e.g., apartment, suite, unit, or building)
    # @param postal_code [String] ZIP or postal code
    # @param state [String] State, county, province, or region
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Monite::OptionalPersonAddressRequest]
    def initialize(city: OMIT, country: OMIT, line_1: OMIT, line_2: OMIT, postal_code: OMIT, state: OMIT, additional_properties: nil)
...
# Deserialize a JSON object to an instance of OptionalPersonAddressRequest
    #
...
# Serialize an instance of OptionalPersonAddressRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  class ReceivablesRepresentationOfCounterpartAddress
...
#  alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
    ...
    # @return [Monite::ReceivablesRepresentationOfCounterpartAddress]
    def initialize(id: OMIT, city:, country:, line_1:, line_2: OMIT, postal_code:, state: OMIT, additional_properties: nil)
      @id = id if id != OMIT
      @city = city
      @country = country
      @line_1 = line_1
      ...
      @_field_set = { "id": id, "city": city, "country": country, "line1": line_1, "line2": line_2, "postal_code": postal_code, "state": state }.reject do | _k, v |
  v == OMIT
end
    end
...
# Serialize an instance of ReceivablesRepresentationOfCounterpartAddress to a JSON
#  object
    #
    # @return [String]
    def to_json

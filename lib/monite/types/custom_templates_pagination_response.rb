...
require_relative "custom_template_data_schema"
require "ostruct"
require "json"

module Monite
  class CustomTemplatesPaginationResponse
  # @return [Array<Monite::CustomTemplateDataSchema>] All user-defined email templates
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::CustomTemplateDataSchema>] All user-defined email templates
...
# Deserialize a JSON object to an instance of CustomTemplatesPaginationResponse
    #
  ...
  item = item.to_json
  Monite::CustomTemplateDataSchema.from_json(json_object: item)
end
...
# Serialize an instance of CustomTemplatesPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

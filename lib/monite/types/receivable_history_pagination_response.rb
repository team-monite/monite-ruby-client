...
require_relative "receivable_history_response"
require "ostruct"
require "json"

module Monite
# A paginated list of change history records.
  class ReceivableHistoryPaginationResponse
  # @return [Array<Monite::ReceivableHistoryResponse>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::ReceivableHistoryResponse>] 
...
# Deserialize a JSON object to an instance of ReceivableHistoryPaginationResponse
    #
  ...
  item = item.to_json
  Monite::ReceivableHistoryResponse.from_json(json_object: item)
end
...
# Serialize an instance of ReceivableHistoryPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
require_relative "verification_airwallex_plaid_request"
...
module Monite
  ...
  # @return [Object] 
    ...
    # @param airwallex_plaid [Monite::VerificationAirwallexPlaidRequest] 
    # @param type [Monite::BankAccountVerificationType] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Monite::VerificationRequest]
...
# Deserialize a JSON object to an instance of VerificationRequest
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["airwallex_plaid"].nil?
        ...
        airwallex_plaid = Monite::VerificationAirwallexPlaidRequest.from_json(json_object: airwallex_plaid)
      else
        airwallex_plaid = nil
      end
...
# Serialize an instance of VerificationRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      Monite::VerificationAirwallexPlaidRequest.validate_raw(obj: obj.airwallex_plaid)

...
module Monite
  class ApprovalPolicyResourceScriptItem


# Deserialize a JSON object to an instance of ApprovalPolicyResourceScriptItem
    #
    # @param json_object [String] 
    # @return [Monite::ApprovalPolicyResourceScriptItem]

...
require_relative "text_template_response"
require "ostruct"
require "json"

module Monite
  class TextTemplateResponseList
  # @return [Array<Monite::TextTemplateResponse>] 
    attr_reader :data
  # @return [String] 
...
# Deserialize a JSON object to an instance of TextTemplateResponseList
    #
  ...
  item = item.to_json
  Monite::TextTemplateResponse.from_json(json_object: item)
end
...
# Serialize an instance of TextTemplateResponseList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

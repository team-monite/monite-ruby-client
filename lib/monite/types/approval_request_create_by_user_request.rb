...
module Monite
  class ApprovalRequestCreateByUserRequest
  # @return [String] 
  ...
  # @return [Object] 
    ...
    # @return [Monite::ApprovalRequestCreateByUserRequest]
    def initialize(object_id:, object_type:, required_approval_count:, user_ids:, additional_properties: nil)
      @object_id = object_id
      @object_type = object_type
      @required_approval_count = required_approval_count
      @user_ids = user_ids
      @additional_properties = additional_properties
      @_field_set = { "object_id": object_id, "object_type": object_type, "required_approval_count": required_approval_count, "user_ids": user_ids }
    end
# Deserialize a JSON object to an instance of ApprovalRequestCreateByUserRequest
    #
...
# Serialize an instance of ApprovalRequestCreateByUserRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

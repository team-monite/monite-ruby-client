...
#  alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
    ...
    # @return [Monite::CounterpartRawAddress]
...
# Deserialize a JSON object to an instance of CounterpartRawAddress
    #
...
# Serialize an instance of CounterpartRawAddress to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

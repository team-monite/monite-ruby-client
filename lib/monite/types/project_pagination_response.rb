...
# A paginated list of projects.
  class ProjectPaginationResponse
  # @return [Array<Monite::ProjectResource>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::ProjectResource>] 
...
# Deserialize a JSON object to an instance of ProjectPaginationResponse
    #
  ...
  item = item.to_json
  Monite::ProjectResource.from_json(json_object: item)
end
...
# Serialize an instance of ProjectPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

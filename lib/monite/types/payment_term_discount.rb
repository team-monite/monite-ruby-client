...
module Monite
  ...
  # @return [Object] 
    ...
    # @return [Monite::PaymentTermDiscount]
...
# Deserialize a JSON object to an instance of PaymentTermDiscount
    #
...
# Serialize an instance of PaymentTermDiscount to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

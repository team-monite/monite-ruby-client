...
module Monite
  class OnboardingPaymentMethodsResponse
  # @return [Array<Monite::PaymentMethod>] 
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::PaymentMethod>] 
...
# Deserialize a JSON object to an instance of OnboardingPaymentMethodsResponse
    #
  ...
  item = item.to_json
  Monite::PaymentMethod.from_json(json_object: item)
end
      new(data: data, additional_properties: struct)
    end
# Serialize an instance of OnboardingPaymentMethodsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
# A schema contains metadata for an organization
  ...
  # @return [String] The legal name of the organization. If this organization will use Monite payment
#  rails, this name must be up to 100 characters long, otherwise it can be up to
#  255 characters long.
  ...
  # @return [Object] 
    ...
    # @param legal_name [String] The legal name of the organization. If this organization will use Monite payment
#  rails, this name must be up to 100 characters long, otherwise it can be up to
#  255 characters long.
    # @param owners_provided [Boolean] 
    # @param representative_provided [Boolean] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Monite::OrganizationSchema]
    def initialize(business_structure: OMIT, directors_provided: OMIT, executives_provided: OMIT, legal_entity_id: OMIT, legal_name:, owners_provided: OMIT, representative_provided: OMIT, additional_properties: nil)
...
# Deserialize a JSON object to an instance of OrganizationSchema
    #
...
# Serialize an instance of OrganizationSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

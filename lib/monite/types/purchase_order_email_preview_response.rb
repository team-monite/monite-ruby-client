...
# A schema for returning a response for email preview
  class PurchaseOrderEmailPreviewResponse
  # @return [String] 
...
# Deserialize a JSON object to an instance of PurchaseOrderEmailPreviewResponse
    #
...
# Serialize an instance of PurchaseOrderEmailPreviewResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  ...
  # @return [Array<Monite::RoleResponse>] array of records
    attr_reader :data
...
#  the last page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::RoleResponse>] array of records
...
# Deserialize a JSON object to an instance of RolePaginationResponse
    #
  ...
  item = item.to_json
  Monite::RoleResponse.from_json(json_object: item)
end
...
# Serialize an instance of RolePaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

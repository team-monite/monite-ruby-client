...
module Monite
  class ReceivableFacadeCreateQuotePayload
  # @return [String] 
...
#  not.
    ...
    # @return [Monite::ReceivableFacadeCreateQuotePayload]
    def initialize(commercial_condition_description: OMIT, counterpart_billing_address_id:, counterpart_business_type: OMIT, counterpart_id:, counterpart_shipping_address_id: OMIT, counterpart_vat_id_id: OMIT, currency:, deduction_amount: OMIT, deduction_memo: OMIT, discount: OMIT, document_id: OMIT, entity: OMIT, entity_bank_account_id: OMIT, entity_vat_id_id: OMIT, expiry_date: OMIT, line_items:, memo: OMIT, partner_metadata: OMIT, project_id: OMIT, quote_accept_page_url: OMIT, signature_required: OMIT, tag_ids: OMIT, trade_name: OMIT, type:, vat_exempt: OMIT, vat_exemption_rationale: OMIT, vat_mode: OMIT, withholding_tax_rate: OMIT, additional_properties: nil)
...
# Deserialize a JSON object to an instance of ReceivableFacadeCreateQuotePayload
    #
...
# Serialize an instance of ReceivableFacadeCreateQuotePayload to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

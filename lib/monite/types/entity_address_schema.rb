...
# A schema represents address info of the entity
  ...
  # @return [String] State, county, province, prefecture, region, or similar component of the
#  entity's address. For US entities, `state` is required and must be a two-letter
#  [USPS state abbreviation](https://pe.usps.com/text/pub28/28apb.htm), for
#  example, NY or CA.
    attr_reader :state
  ...
  # @return [Object] 
    ...
    # @param state [String] State, county, province, prefecture, region, or similar component of the
#  entity's address. For US entities, `state` is required and must be a two-letter
#  [USPS state abbreviation](https://pe.usps.com/text/pub28/28apb.htm), for
#  example, NY or CA.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Monite::EntityAddressSchema]
...
# Deserialize a JSON object to an instance of EntityAddressSchema
    #
...
# Serialize an instance of EntityAddressSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
require_relative "receivable_mail_response"
require "ostruct"
require "json"

module Monite
  class ReceivableMailPaginationResponse
  # @return [Array<Monite::ReceivableMailResponse>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::ReceivableMailResponse>] 
...
# Deserialize a JSON object to an instance of ReceivableMailPaginationResponse
    #
  ...
  item = item.to_json
  Monite::ReceivableMailResponse.from_json(json_object: item)
end
...
# Serialize an instance of ReceivableMailPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  ...
  # @return [Object] 
    ...
    def initialize(current_deadline: OMIT, currently_due:, eventually_due:, pending_verification:, additional_properties: nil)
      @current_deadline = current_deadline if current_deadline != OMIT
      @currently_due = currently_due
      @eventually_due = eventually_due
      @pending_verification = pending_verification
      @additional_properties = additional_properties
      @_field_set = { "current_deadline": current_deadline, "currently_due": currently_due, "eventually_due": eventually_due, "pending_verification": pending_verification }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of PaymentRequirements
    #
...
# Serialize an instance of PaymentRequirements to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

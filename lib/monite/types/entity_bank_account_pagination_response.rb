...
require_relative "entity_bank_account_response"
require "ostruct"
require "json"

module Monite
# A paginated list of an entity's bank accounts.
  class EntityBankAccountPaginationResponse
  # @return [Array<Monite::EntityBankAccountResponse>] A list of an entity's bank accounts.
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::EntityBankAccountResponse>] A list of an entity's bank accounts.
...
# Deserialize a JSON object to an instance of EntityBankAccountPaginationResponse
    #
  ...
  item = item.to_json
  Monite::EntityBankAccountResponse.from_json(json_object: item)
end
...
# Serialize an instance of EntityBankAccountPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

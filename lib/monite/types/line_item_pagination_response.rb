...
module Monite
  class LineItemPaginationResponse
...
# Deserialize a JSON object to an instance of LineItemPaginationResponse
    #
...
# Serialize an instance of LineItemPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  ...
  # @return [Object] 
    ...
    # @return [Monite::CommonSchemaInput]
...
# Deserialize a JSON object to an instance of CommonSchemaInput
    #
...
# Serialize an instance of CommonSchemaInput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  ...
  # @return [Object] 
    ...
    # @return [Monite::PaymentAccountObject]
...
# Deserialize a JSON object to an instance of PaymentAccountObject
    #
...
# Serialize an instance of PaymentAccountObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

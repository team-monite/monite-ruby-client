...
#  that has initially caused the event
    ...
    # @return [Monite::EventResource]
    def initialize(id:, created_at: OMIT, action:, api_version: OMIT, description:, entity_id:, object: OMIT, object_type:, additional_properties: nil)
      @id = id
      ...
      @_field_set = { "id": id, "created_at": created_at, "action": action, "api_version": api_version, "description": description, "entity_id": entity_id, "object": object, "object_type": object_type }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of EventResource
    #
...
# Serialize an instance of EventResource to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

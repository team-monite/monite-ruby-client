...
# A Request schema for an entity of organization type
  class ReceivableEntityOrganizationRequest
  ...
  # @return [Object] 
    ...
    # @return [Monite::ReceivableEntityOrganizationRequest]
    def initialize(email: OMIT, logo: OMIT, name:, phone: OMIT, tax_id: OMIT, website: OMIT, additional_properties: nil)
      ...
      @_field_set = { "email": email, "logo": logo, "name": name, "phone": phone, "tax_id": tax_id, "website": website }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of ReceivableEntityOrganizationRequest
    #
...
# Serialize an instance of ReceivableEntityOrganizationRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

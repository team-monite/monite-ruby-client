...
module Monite
  ...
  # @return [Object] 
    ...
    # @return [Monite::CounterpartRawVatId]
...
# Deserialize a JSON object to an instance of CounterpartRawVatId
    #
...
# Serialize an instance of CounterpartRawVatId to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

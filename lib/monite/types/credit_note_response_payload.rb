...
require_relative "credit_note_response_payload_entity"
...
require_relative "credit_note_state_enum"
...
module Monite
  class CreditNoteResponsePayload
  # @return [String] 
    attr_reader :id
...
#  generated.
  ...
  # @return [Monite::CreditNoteStateEnum] The status of the Credit Note inside the receivable workflow.
    attr_reader :status
...
#  units](https://docs.monite.com/references/currencies#minor-units).
    ...
    # @param entity [Monite::CreditNoteResponsePayloadEntity] 
...
#  generated.
    ...
    # @param status [Monite::CreditNoteStateEnum] The status of the Credit Note inside the receivable workflow.
...
#  not.
    ...
    # @return [Monite::CreditNoteResponsePayload]
    def initialize(id:, created_at:, updated_at:, based_on: OMIT, based_on_document_id: OMIT, commercial_condition_description: OMIT, counterpart_billing_address: OMIT, counterpart_business_type: OMIT, counterpart_contact: OMIT, counterpart_id:, counterpart_name: OMIT, counterpart_shipping_address: OMIT, counterpart_tax_id: OMIT, counterpart_type:, counterpart_vat_id: OMIT, currency:, deduction_amount: OMIT, deduction_memo: OMIT, discount: OMIT, discounted_subtotal: OMIT, document_id: OMIT, due_date: OMIT, entity:, entity_address:, entity_bank_account: OMIT, entity_user_id: OMIT, entity_vat_id: OMIT, file_language:, file_url: OMIT, issue_date: OMIT, line_items:, memo: OMIT, original_file_language:, original_file_url: OMIT, partner_metadata: OMIT, project_id: OMIT, purchase_order: OMIT, status:, subtotal: OMIT, tags: OMIT, total_amount: OMIT, total_vat_amount:, total_vat_amounts: OMIT, total_withholding_tax: OMIT, trade_name: OMIT, vat_exempt: OMIT, vat_exemption_rationale: OMIT, vat_mode: OMIT, withholding_tax_rate: OMIT, additional_properties: nil)
      @id = id
...
# Deserialize a JSON object to an instance of CreditNoteResponsePayload
    #
  ...
  nil
      ...
      unless parsed_json["entity"].nil?
        ...
        entity = Monite::CreditNoteResponsePayloadEntity.from_json(json_object: entity)
      else
        entity = nil
      end
...
# Serialize an instance of CreditNoteResponsePayload to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Monite::CreditNoteResponsePayloadEntity.validate_raw(obj: obj.entity)
      ...
      obj.status.is_a?(Monite::CreditNoteStateEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")

...
require "date"
require "date"
require_relative "counterpart_individual_response"
...
# Represents counterparts that are individuals (natural persons).
  class CounterpartIndividualRootResponse
...
#  as the billing address for ACH payments.
    ...
    # @param individual [Monite::CounterpartIndividualResponse] 
...
#  person).
    ...
    # @return [Monite::CounterpartIndividualRootResponse]
...
# Deserialize a JSON object to an instance of CounterpartIndividualRootResponse
    #
  ...
  nil
      ...
      unless parsed_json["individual"].nil?
        ...
        individual = Monite::CounterpartIndividualResponse.from_json(json_object: individual)
      else
        individual = nil
      end
...
# Serialize an instance of CounterpartIndividualRootResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Monite::CounterpartIndividualResponse.validate_raw(obj: obj.individual)

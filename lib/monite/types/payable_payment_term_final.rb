...
# Deserialize a JSON object to an instance of PayablePaymentTermFinal
    #
...
# Serialize an instance of PayablePaymentTermFinal to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

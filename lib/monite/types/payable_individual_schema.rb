...
# A schema contains metadata for an individual
  ...
  # @return [Object] 
    ...
    # @return [Monite::PayableIndividualSchema]
...
# Deserialize a JSON object to an instance of PayableIndividualSchema
    #
...
# Serialize an instance of PayableIndividualSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
# Address information.
  class CounterpartRawAddressUpdateRequest
...
#  alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
    ...
    # @return [Monite::CounterpartRawAddressUpdateRequest]
...
# Deserialize a JSON object to an instance of CounterpartRawAddressUpdateRequest
    #
...
# Serialize an instance of CounterpartRawAddressUpdateRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

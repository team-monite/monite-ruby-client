...
module Monite
  class OnboardingRequirementsError
  # @return [String] 
    attr_reader :code
  # @return [String] 
    attr_reader :reason
  ...
  # @return [Object] 
    ...
    # @return [Monite::OnboardingRequirementsError]
...
# Deserialize a JSON object to an instance of OnboardingRequirementsError
    #
...
# Serialize an instance of OnboardingRequirementsError to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
require "date"
require_relative "page_schema"
require_relative "preview_schema"
require "ostruct"
require "json"
...
#  type](https://developer.mozilla.org/en-US/docs/Web/HTTP/MIME_types).
  ...
  # @return [String] The original file name (if available).
    attr_reader :name
  # @return [Array<Monite::PageSchema>] If the file is a PDF document, this property contains individual pages extracted
#  from the file. Otherwise, an empty array.
    attr_reader :pages
  # @return [Array<Monite::PreviewSchema>] Preview images generated for this file. There can be multiple images with
#  different sizes.
...
#  type](https://developer.mozilla.org/en-US/docs/Web/HTTP/MIME_types).
    ...
    # @param pages [Array<Monite::PageSchema>] If the file is a PDF document, this property contains individual pages extracted
#  from the file. Otherwise, an empty array.
    # @param previews [Array<Monite::PreviewSchema>] Preview images generated for this file. There can be multiple images with
#  different sizes.
...
# Deserialize a JSON object to an instance of FileSchema3
    #
  ...
  item = item.to_json
  Monite::PageSchema.from_json(json_object: item)
end
      previews = parsed_json["previews"]&.map do | item |
  item = item.to_json
  Monite::PreviewSchema.from_json(json_object: item)
end
...
# Serialize an instance of FileSchema3 to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

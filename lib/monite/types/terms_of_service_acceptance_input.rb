...
module Monite
  class TermsOfServiceAcceptanceInput
...
#  inferred from the request origin or the `X-Forwarded-For` request header.
    ...
    # @return [Monite::TermsOfServiceAcceptanceInput]
...
# Deserialize a JSON object to an instance of TermsOfServiceAcceptanceInput
    #
...
# Serialize an instance of TermsOfServiceAcceptanceInput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

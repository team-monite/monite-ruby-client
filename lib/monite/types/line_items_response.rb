...
module Monite
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::ResponseItem>] 
...
# Deserialize a JSON object to an instance of LineItemsResponse
    #
...
# Serialize an instance of LineItemsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

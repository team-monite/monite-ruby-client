...
# Contains data specific to entities of the `organization` type.
  ...
  # @return [Object] 
    ...
    # @return [Monite::OrganizationResponseSchema]
...
# Deserialize a JSON object to an instance of OrganizationResponseSchema
    #
...
# Serialize an instance of OrganizationResponseSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

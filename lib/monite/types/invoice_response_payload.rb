...
require_relative "invoice_response_payload_entity"
...
require "date"
require_relative "payment_terms"
require_relative "related_documents"
...
#  standard.
  ...
  # @return [Integer] How much is left to be paid in [minor
#  units](https://docs.monite.com/references/currencies#minor-units). Equal 0 if
#  the Invoice is fully paid.
    attr_reader :amount_due
  # @return [Integer] How much has been paid [minor
#  units](https://docs.monite.com/references/currencies#minor-units)
    attr_reader :amount_paid
  # @return [Integer] How much is left to be paid in in [minor
#  units](https://docs.monite.com/references/currencies#minor-units), including
#  payment_term discounts.
...
#  applicable.
  ...
  # @return [String] Field with a comment for pay/partially/uncollectible info on this Invoice
    attr_reader :comment
...
#  units](https://docs.monite.com/references/currencies#minor-units).
  ...
  # @return [Monite::InvoiceResponsePayloadEntity] 
    attr_reader :entity
...
#  generated.
  ...
  # @return [DateTime] Date and time when the invoice was paid.
    attr_reader :paid_at
...
#  payment links.
  ...
  # @return [String] Stores an unique ID of a recurrence if the receivable is in a recurring status
    attr_reader :recurrence_id
  # @return [Monite::RelatedDocuments] Ids of documents that relate to invoice. I.e credit notes, proforma invoices,
#  etc.
    attr_reader :related_documents
  # @return [Monite::ReceivablesStatusEnum] The status of the receivable inside the receivable workflow.
    attr_reader :status
...
#  a subtotal + total_vat_amount.
  ...
  # @return [Integer] The total price of the receivable in [minor
#  units](https://docs.monite.com/references/currencies#minor-units), including VAT
#  and excluding all issued credit notes.
...
#  standard.
    # @param amount_due [Integer] How much is left to be paid in [minor
#  units](https://docs.monite.com/references/currencies#minor-units). Equal 0 if
#  the Invoice is fully paid.
    # @param amount_paid [Integer] How much has been paid [minor
#  units](https://docs.monite.com/references/currencies#minor-units)
    # @param amount_to_pay [Integer] How much is left to be paid in in [minor
#  units](https://docs.monite.com/references/currencies#minor-units), including
#  payment_term discounts.
...
#  applicable.
    # @param comment [String] Field with a comment for pay/partially/uncollectible info on this Invoice
...
#  units](https://docs.monite.com/references/currencies#minor-units).
    ...
    # @param entity [Monite::InvoiceResponsePayloadEntity] 
...
#  payment links.
    ...
    # @param payment_terms [Monite::PaymentTerms] 
    # @param project_id [String] A project related to current receivable
    # @param purchase_order [String] Contain purchase order number.
    # @param recurrence_id [String] Stores an unique ID of a recurrence if the receivable is in a recurring status
    # @param related_documents [Monite::RelatedDocuments] Ids of documents that relate to invoice. I.e credit notes, proforma invoices,
#  etc.
    # @param status [Monite::ReceivablesStatusEnum] The status of the receivable inside the receivable workflow.
...
#  units](https://docs.monite.com/references/currencies#minor-units). Calculated as
#  a subtotal + total_vat_amount.
    # @param total_amount_with_credit_notes [Integer] The total price of the receivable in [minor
#  units](https://docs.monite.com/references/currencies#minor-units), including VAT
#  and excluding all issued credit notes.
...
#  not.
    ...
    def initialize(id:, created_at:, updated_at:, amount_due:, amount_paid:, amount_to_pay: OMIT, based_on: OMIT, based_on_document_id: OMIT, comment: OMIT, commercial_condition_description: OMIT, counterpart_billing_address: OMIT, counterpart_business_type: OMIT, counterpart_contact: OMIT, counterpart_id:, counterpart_name: OMIT, counterpart_shipping_address: OMIT, counterpart_tax_id: OMIT, counterpart_type:, counterpart_vat_id: OMIT, currency:, deduction_amount: OMIT, deduction_memo: OMIT, discount: OMIT, discounted_subtotal: OMIT, document_id: OMIT, due_date: OMIT, entity:, entity_address:, entity_bank_account: OMIT, entity_user_id: OMIT, entity_vat_id: OMIT, file_language:, file_url: OMIT, fulfillment_date: OMIT, issue_date: OMIT, line_items:, memo: OMIT, original_file_language:, original_file_url: OMIT, overdue_reminder_id: OMIT, paid_at: OMIT, partner_metadata: OMIT, payment_page_url: OMIT, payment_reminder_id: OMIT, payment_terms: OMIT, project_id: OMIT, purchase_order: OMIT, recurrence_id: OMIT, related_documents:, status:, subtotal: OMIT, tags: OMIT, total_amount: OMIT, total_amount_with_credit_notes:, total_vat_amount:, total_vat_amounts: OMIT, total_withholding_tax: OMIT, trade_name: OMIT, vat_exempt: OMIT, vat_exemption_rationale: OMIT, vat_mode: OMIT, withholding_tax_rate: OMIT, additional_properties: nil)
      ...
      @recurrence_id = recurrence_id if recurrence_id != OMIT
...
# Deserialize a JSON object to an instance of InvoiceResponsePayload
  ...
  nil
      ...
      unless parsed_json["entity"].nil?
        ...
        entity = Monite::InvoiceResponsePayloadEntity.from_json(json_object: entity)
      else
        entity = nil
      end
  ...
  nil
      ...
      unless parsed_json["payment_terms"].nil?
        ...
        payment_terms = Monite::PaymentTerms.from_json(json_object: payment_terms)
      else
        payment_terms = nil
      end
      project_id = parsed_json["project_id"]
      purchase_order = parsed_json["purchase_order"]
      recurrence_id = parsed_json["recurrence_id"]
      unless parsed_json["related_documents"].nil?
        related_documents = parsed_json["related_documents"].to_json
        related_documents = Monite::RelatedDocuments.from_json(json_object: related_documents)
      else
        related_documents = nil
      end
...
# Serialize an instance of InvoiceResponsePayload to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Monite::InvoiceResponsePayloadEntity.validate_raw(obj: obj.entity)
      ...
      obj.payment_terms.nil? || Monite::PaymentTerms.validate_raw(obj: obj.payment_terms)
      ...
      obj.recurrence_id&.is_a?(String) != false || raise("Passed value for field obj.recurrence_id is not the expected type, validation failed.")
      Monite::RelatedDocuments.validate_raw(obj: obj.related_documents)
      obj.status.is_a?(Monite::ReceivablesStatusEnum) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")

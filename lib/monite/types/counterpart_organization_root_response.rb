...
require_relative "counterpart_organization_response"
...
# Represents counterparts that are organizations (juridical persons).
  class CounterpartOrganizationRootResponse
...
#  as the billing address for ACH payments.
  ...
  # @return [String] The counterpart's taxpayer identification number or tax ID.
    attr_reader :tax_id
...
#  as the billing address for ACH payments.
    ...
    # @param organization [Monite::CounterpartOrganizationResponse] 
    # @param reminders_enabled [Boolean] 
    # @param tax_id [String] The counterpart's taxpayer identification number or tax ID.
...
#  person).
    ...
    # @return [Monite::CounterpartOrganizationRootResponse]
    def initialize(id:, created_at:, updated_at:, created_automatically: OMIT, default_billing_address_id: OMIT, default_shipping_address_id: OMIT, created_by_entity_user_id: OMIT, language: OMIT, organization:, reminders_enabled: OMIT, tax_id: OMIT, type:, additional_properties: nil)
      @id = id
...
# Deserialize a JSON object to an instance of CounterpartOrganizationRootResponse
    #
  ...
  nil
      ...
      unless parsed_json["organization"].nil?
        ...
        organization = Monite::CounterpartOrganizationResponse.from_json(json_object: organization)
      else
        organization = nil
      end
...
# Serialize an instance of CounterpartOrganizationRootResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Monite::CounterpartOrganizationResponse.validate_raw(obj: obj.organization)

...
# Contains data specific to entities of the `individual` type.
  class IndividualResponseSchema
  # @return [String] 
  ...
  # @return [Object] 
    ...
    # @return [Monite::IndividualResponseSchema]
...
# Deserialize a JSON object to an instance of IndividualResponseSchema
    #
...
# Serialize an instance of IndividualResponseSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

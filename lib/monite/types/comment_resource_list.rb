...
module Monite
  ...
  # @return [Array<Monite::CommentResource>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::CommentResource>] 
...
# Deserialize a JSON object to an instance of CommentResourceList
    #
  ...
  item = item.to_json
  Monite::CommentResource.from_json(json_object: item)
end
...
# Serialize an instance of CommentResourceList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

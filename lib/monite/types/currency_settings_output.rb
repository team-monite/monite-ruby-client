...
# Deserialize a JSON object to an instance of CurrencySettingsOutput
    #
...
# Serialize an instance of CurrencySettingsOutput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

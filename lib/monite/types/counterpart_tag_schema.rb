...
#  8601](https://en.wikipedia.org/wiki/ISO_8601) standard.
  ...
  # @return [Monite::CounterpartTagCategory] The tag category.
...
#  8601](https://en.wikipedia.org/wiki/ISO_8601) standard.
    # @param category [Monite::CounterpartTagCategory] The tag category.
    ...
    # @return [Monite::CounterpartTagSchema]
...
# Deserialize a JSON object to an instance of CounterpartTagSchema
    #
...
# Serialize an instance of CounterpartTagSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.category&.is_a?(Monite::CounterpartTagCategory) != false || raise("Passed value for field obj.category is not the expected type, validation failed.")

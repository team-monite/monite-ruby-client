...
#  the organization
    ...
    # @return [Monite::PersonRelationshipResponse]
...
# Deserialize a JSON object to an instance of PersonRelationshipResponse
    #
...
# Serialize an instance of PersonRelationshipResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  ...
  # @return [Array<Monite::PersonResponse>] array of objects of type person
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::PersonResponse>] array of objects of type person
...
# Deserialize a JSON object to an instance of PersonsResponse
    #
  ...
  item = item.to_json
  Monite::PersonResponse.from_json(json_object: item)
end
      new(data: data, additional_properties: struct)
    end
# Serialize an instance of PersonsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

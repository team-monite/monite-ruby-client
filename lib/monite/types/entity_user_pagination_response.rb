...
require_relative "entity_user_response"
require "ostruct"
require "json"

module Monite
  class EntityUserPaginationResponse
  # @return [Array<Monite::EntityUserResponse>] array of records
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::EntityUserResponse>] array of records
...
# Deserialize a JSON object to an instance of EntityUserPaginationResponse
    #
  ...
  item = item.to_json
  Monite::EntityUserResponse.from_json(json_object: item)
end
...
# Serialize an instance of EntityUserPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

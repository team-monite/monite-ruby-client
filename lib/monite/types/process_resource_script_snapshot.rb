...
# The script snapshot taken when script started.
  class ProcessResourceScriptSnapshot


# Deserialize a JSON object to an instance of ProcessResourceScriptSnapshot
    #
    # @param json_object [String] 
    # @return [Monite::ProcessResourceScriptSnapshot]

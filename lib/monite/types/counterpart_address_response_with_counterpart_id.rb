...
module Monite
# Address information.
  class CounterpartAddressResponseWithCounterpartId
  # @return [String] Unique ID of the address in the system
    attr_reader :id
  # @return [String] City name.
    attr_reader :city
  # @return [String] ID of the counterpart that owns the address.
...
#  alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
  ...
  # @return [Object] 
    ...
    # @param id [String] Unique ID of the address in the system
    # @param city [String] City name.
    # @param counterpart_id [String] ID of the counterpart that owns the address.
...
#  alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
    ...
    def initialize(id:, city:, counterpart_id:, country:, line_1:, line_2: OMIT, postal_code:, state: OMIT, additional_properties: nil)
      @id = id
      @city = city
      ...
      @_field_set = { "id": id, "city": city, "counterpart_id": counterpart_id, "country": country, "line1": line_1, "line2": line_2, "postal_code": postal_code, "state": state }.reject do | _k, v |
  v == OMIT
end
    end
...
# Serialize an instance of CounterpartAddressResponseWithCounterpartId to a JSON
#  object
    #
    # @return [String]
    def to_json

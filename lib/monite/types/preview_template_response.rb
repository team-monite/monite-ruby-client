...
# Deserialize a JSON object to an instance of PreviewTemplateResponse
    #
...
# Serialize an instance of PreviewTemplateResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

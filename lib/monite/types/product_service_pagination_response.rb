...
require_relative "product_service_response"
require "ostruct"
require "json"

module Monite
# A paginated list of products and services
  class ProductServicePaginationResponse
  # @return [Array<Monite::ProductServiceResponse>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::ProductServiceResponse>] 
...
# Deserialize a JSON object to an instance of ProductServicePaginationResponse
    #
  ...
  item = item.to_json
  Monite::ProductServiceResponse.from_json(json_object: item)
end
...
# Serialize an instance of ProductServicePaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
# Represents counterparts that are individuals (natural persons).
  class CounterpartIndividualUpdatePayload
  ...
  # @return [Object] 
    ...
    def initialize(email: OMIT, first_name: OMIT, is_customer: OMIT, is_vendor: OMIT, last_name: OMIT, phone: OMIT, tag_ids: OMIT, title: OMIT, additional_properties: nil)
      ...
      @_field_set = { "email": email, "first_name": first_name, "is_customer": is_customer, "is_vendor": is_vendor, "last_name": last_name, "phone": phone, "tag_ids": tag_ids, "title": title }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of CounterpartIndividualUpdatePayload
    #
...
# Serialize an instance of CounterpartIndividualUpdatePayload to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
require_relative "approval_policy_resource"
require "ostruct"
require "json"

module Monite
  class ApprovalPolicyResourceList
  # @return [Array<Monite::ApprovalPolicyResource>] 
    attr_reader :data
...
#  the last page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::ApprovalPolicyResource>] 
...
# Deserialize a JSON object to an instance of ApprovalPolicyResourceList
    #
  ...
  item = item.to_json
  Monite::ApprovalPolicyResource.from_json(json_object: item)
end
...
# Serialize an instance of ApprovalPolicyResourceList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

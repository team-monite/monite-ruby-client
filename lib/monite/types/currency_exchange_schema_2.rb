...
# Deserialize a JSON object to an instance of CurrencyExchangeSchema2
    #
...
# Serialize an instance of CurrencyExchangeSchema2 to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

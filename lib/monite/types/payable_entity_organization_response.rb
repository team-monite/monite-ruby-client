...
require_relative "payable_organization_schema"
...
# A base for an entity response schema
  class PayableEntityOrganizationResponse
  ...
  # @return [Monite::FileSchema4] A logo image of the entity
    attr_reader :logo
  # @return [Monite::PayableOrganizationSchema] A set of metadata describing an organization
...
#  for entities that are non-VAT registered.
  ...
  # @return [Object] 
    ...
    # @param organization [Monite::PayableOrganizationSchema] A set of metadata describing an organization
...
#  for entities that are non-VAT registered.
    ...
    # @return [Monite::PayableEntityOrganizationResponse]
...
# Deserialize a JSON object to an instance of PayableEntityOrganizationResponse
    #
  ...
  nil
      ...
      unless parsed_json["organization"].nil?
        ...
        organization = Monite::PayableOrganizationSchema.from_json(json_object: organization)
      else
        organization = nil
      end
...
# Serialize an instance of PayableEntityOrganizationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Monite::PayableOrganizationSchema.validate_raw(obj: obj.organization)

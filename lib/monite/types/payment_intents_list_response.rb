...
require_relative "payment_intent_response"
require "ostruct"
require "json"

module Monite
  class PaymentIntentsListResponse
  # @return [Array<Monite::PaymentIntentResponse>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::PaymentIntentResponse>] 
...
# Deserialize a JSON object to an instance of PaymentIntentsListResponse
    #
  ...
  item = item.to_json
  Monite::PaymentIntentResponse.from_json(json_object: item)
end
...
# Serialize an instance of PaymentIntentsListResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

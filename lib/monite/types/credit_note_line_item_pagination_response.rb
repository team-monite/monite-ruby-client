...
require_relative "credit_note_line_item_response"
require "ostruct"
require "json"

module Monite
# A paginated list of credit note line items.
  class CreditNoteLineItemPaginationResponse
  # @return [Array<Monite::CreditNoteLineItemResponse>] List of credit note line items for the current page
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::CreditNoteLineItemResponse>] List of credit note line items for the current page
...
# Deserialize a JSON object to an instance of CreditNoteLineItemPaginationResponse
    #
  ...
  item = item.to_json
  Monite::CreditNoteLineItemResponse.from_json(json_object: item)
end
...
# Serialize an instance of CreditNoteLineItemPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  ...
  # @return [Object] 
    ...
    def initialize(id:, created_at:, updated_at:, entity_id: OMIT, file_type:, md_5:, mimetype:, name:, region:, s_3_bucket:, s_3_file_path:, size:, url:, additional_properties: nil)
      @id = id
      @created_at = created_at
      @updated_at = updated_at
      @entity_id = entity_id if entity_id != OMIT
      @file_type = file_type
      @md_5 = md_5
      @mimetype = mimetype
      @name = name
      ...
      @_field_set = { "id": id, "created_at": created_at, "updated_at": updated_at, "entity_id": entity_id, "file_type": file_type, "md5": md_5, "mimetype": mimetype, "name": name, "region": region, "s3_bucket": s_3_bucket, "s3_file_path": s_3_file_path, "size": size, "url": url }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of FileSchema
    #
...
# Serialize an instance of FileSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

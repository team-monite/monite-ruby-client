...
module Monite
  class PersonAddressResponse
  # @return [String] City, district, suburb, town, or village
    attr_reader :city
  # @return [String] Two-letter country code (ISO 3166-1 alpha-2)
    attr_reader :country
  ...
  # @return [Object] 
    ...
    # @return [Monite::PersonAddressResponse]
...
# Deserialize a JSON object to an instance of PersonAddressResponse
    #
...
# Serialize an instance of PersonAddressResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

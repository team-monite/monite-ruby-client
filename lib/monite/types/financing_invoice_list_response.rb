...
require_relative "financing_invoice"
require "ostruct"
require "json"

module Monite
  class FinancingInvoiceListResponse
  # @return [Array<Monite::FinancingInvoice>] A list of invoices requested for financing.
    attr_reader :data
...
#  the last page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::FinancingInvoice>] A list of invoices requested for financing.
...
# Deserialize a JSON object to an instance of FinancingInvoiceListResponse
    #
  ...
  item = item.to_json
  Monite::FinancingInvoice.from_json(json_object: item)
end
...
# Serialize an instance of FinancingInvoiceListResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  class CounterpartRawBankAccountUpdateRequest
...
#  document).
    ...
    # @return [Monite::CounterpartRawBankAccountUpdateRequest]
...
# Serialize an instance of CounterpartRawBankAccountUpdateRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

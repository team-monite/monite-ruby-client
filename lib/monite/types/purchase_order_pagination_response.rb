...
require_relative "purchase_order_response_schema"
require "ostruct"
require "json"

module Monite
# A paginated list of purchase orders.
  class PurchaseOrderPaginationResponse
  # @return [Array<Monite::PurchaseOrderResponseSchema>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::PurchaseOrderResponseSchema>] 
...
# Deserialize a JSON object to an instance of PurchaseOrderPaginationResponse
    #
  ...
  item = item.to_json
  Monite::PurchaseOrderResponseSchema.from_json(json_object: item)
end
...
# Serialize an instance of PurchaseOrderPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

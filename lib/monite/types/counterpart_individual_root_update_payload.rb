...
require_relative "counterpart_individual_update_payload"
...
# Represents counterparts that are individuals (natural persons).
  class CounterpartIndividualRootUpdatePayload
...
#  as the billing address for ACH payments.
  ...
  # @return [Monite::CounterpartIndividualUpdatePayload] 
...
#  as the billing address for ACH payments.
    ...
    # @param individual [Monite::CounterpartIndividualUpdatePayload] 
...
#  VAT-registered.
    ...
    # @return [Monite::CounterpartIndividualRootUpdatePayload]
    def initialize(default_billing_address_id: OMIT, default_shipping_address_id: OMIT, individual:, language: OMIT, reminders_enabled: OMIT, tax_id: OMIT, additional_properties: nil)
      ...
      @_field_set = { "default_billing_address_id": default_billing_address_id, "default_shipping_address_id": default_shipping_address_id, "individual": individual, "language": language, "reminders_enabled": reminders_enabled, "tax_id": tax_id }.reject do | _k, v |
  v == OMIT
end
    end
...
#  CounterpartIndividualRootUpdatePayload
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["individual"].nil?
        ...
        individual = Monite::CounterpartIndividualUpdatePayload.from_json(json_object: individual)
      else
        individual = nil
      end
...
# Serialize an instance of CounterpartIndividualRootUpdatePayload to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Monite::CounterpartIndividualUpdatePayload.validate_raw(obj: obj.individual)

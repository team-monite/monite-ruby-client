...
# A schema for metadata for updating an individual
  class OptionalIndividualSchema
  # @return [String] 
  ...
  # @return [Object] 
    ...
    # @return [Monite::OptionalIndividualSchema]
    def initialize(date_of_birth: OMIT, first_name: OMIT, id_number: OMIT, last_name: OMIT, ssn_last_4: OMIT, title: OMIT, additional_properties: nil)
...
# Deserialize a JSON object to an instance of OptionalIndividualSchema
    #
...
# Serialize an instance of OptionalIndividualSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

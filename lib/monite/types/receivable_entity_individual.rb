...
# A Response schema for an entity of individual type
  class ReceivableEntityIndividual
  ...
  # @return [Object] 
    ...
    # @return [Monite::ReceivableEntityIndividual]
...
# Deserialize a JSON object to an instance of ReceivableEntityIndividual
    #
...
# Serialize an instance of ReceivableEntityIndividual to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  class OcrResponseInvoiceReceiptLineItemRaw
  ...
  # @return [Float] Price as parsed
    attr_reader :unit_price
  # @return [String] Unit
    attr_reader :unit
  # @return [Float] VAT Percent as parsed.
    attr_reader :vat_percentage
  # @return [Float] VAT Amount as parsed.
    attr_reader :vat_amount
  # @return [Float] Total excluded VAT as parsed.
    attr_reader :total_excl_vat
  # @return [Float] Total included VAT as parsed.
  ...
  # @return [Object] 
    ...
    # @param unit_price [Float] Price as parsed
    # @param unit [String] Unit
    # @param vat_percentage [Float] VAT Percent as parsed.
    # @param vat_amount [Float] VAT Amount as parsed.
    # @param total_excl_vat [Float] Total excluded VAT as parsed.
    # @param total_incl_vat [Float] Total included VAT as parsed.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Monite::OcrResponseInvoiceReceiptLineItemRaw]
...
# Deserialize a JSON object to an instance of OcrResponseInvoiceReceiptLineItemRaw
    #
...
# Serialize an instance of OcrResponseInvoiceReceiptLineItemRaw to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.vat_percentage&.is_a?(Float) != false || raise("Passed value for field obj.vat_percentage is not the expected type, validation failed.")
      obj.vat_amount&.is_a?(Float) != false || raise("Passed value for field obj.vat_amount is not the expected type, validation failed.")
      obj.total_excl_vat&.is_a?(Float) != false || raise("Passed value for field obj.total_excl_vat is not the expected type, validation failed.")
      obj.total_incl_vat&.is_a?(Float) != false || raise("Passed value for field obj.total_incl_vat is not the expected type, validation failed.")
    end
  end
end
...
module Monite
  ...
  # @return [Object] 
    ...
    # @return [Monite::PersonAddressRequest]
...
# Deserialize a JSON object to an instance of PersonAddressRequest
    #
...
# Serialize an instance of PersonAddressRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

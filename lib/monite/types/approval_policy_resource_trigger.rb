...
#  specifies the event that will trigger the policy to be evaluated.
  class ApprovalPolicyResourceTrigger


# Deserialize a JSON object to an instance of ApprovalPolicyResourceTrigger
    #
    # @param json_object [String] 
    # @return [Monite::ApprovalPolicyResourceTrigger]

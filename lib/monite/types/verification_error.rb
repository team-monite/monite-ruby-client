...
module Monite
  ...
  # @return [Object] 
    ...
    # @return [Monite::VerificationError]
...
# Deserialize a JSON object to an instance of VerificationError
    #
...
# Serialize an instance of VerificationError to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

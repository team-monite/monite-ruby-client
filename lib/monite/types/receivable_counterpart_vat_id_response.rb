...
module Monite
  class ReceivableCounterpartVatIdResponse
  # @return [String] 
    attr_reader :id
  # @return [String] 
...
# Deserialize a JSON object to an instance of ReceivableCounterpartVatIdResponse
    #
...
# Serialize an instance of ReceivableCounterpartVatIdResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

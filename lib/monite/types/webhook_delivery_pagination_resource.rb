...
require_relative "webhook_delivery_resource"
require "ostruct"
require "json"

module Monite
  class WebhookDeliveryPaginationResource
  # @return [Array<Monite::WebhookDeliveryResource>] A set of webhooks returned per page
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::WebhookDeliveryResource>] A set of webhooks returned per page
...
# Deserialize a JSON object to an instance of WebhookDeliveryPaginationResource
    #
  ...
  item = item.to_json
  Monite::WebhookDeliveryResource.from_json(json_object: item)
end
...
# Serialize an instance of WebhookDeliveryPaginationResource to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

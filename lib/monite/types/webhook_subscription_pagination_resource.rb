...
require_relative "webhook_subscription_resource"
require "ostruct"
require "json"

module Monite
  class WebhookSubscriptionPaginationResource
  # @return [Array<Monite::WebhookSubscriptionResource>] A set of webhook settings of different types returned per page
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::WebhookSubscriptionResource>] A set of webhook settings of different types returned per page
...
#  WebhookSubscriptionPaginationResource
  ...
  item = item.to_json
  Monite::WebhookSubscriptionResource.from_json(json_object: item)
end
...
# Serialize an instance of WebhookSubscriptionPaginationResource to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
#  two-letter country codes (ISO 3166-2 alpha-2).
    ...
    # @return [Monite::BusinessProfileOutput]
...
# Deserialize a JSON object to an instance of BusinessProfileOutput
    #
...
# Serialize an instance of BusinessProfileOutput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

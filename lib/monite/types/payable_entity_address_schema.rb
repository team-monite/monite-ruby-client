...
# A schema represents address info of the entity
  class PayableEntityAddressSchema
...
# Deserialize a JSON object to an instance of PayableEntityAddressSchema
    #
...
# Serialize an instance of PayableEntityAddressSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

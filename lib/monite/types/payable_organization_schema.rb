...
# A schema contains metadata for an organization
  class PayableOrganizationSchema
  ...
  # @return [Object] 
    ...
    # @return [Monite::PayableOrganizationSchema]
...
# Deserialize a JSON object to an instance of PayableOrganizationSchema
    #
...
# Serialize an instance of PayableOrganizationSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

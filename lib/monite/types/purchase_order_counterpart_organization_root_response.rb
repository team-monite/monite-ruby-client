...
require_relative "purchase_order_counterpart_organization_response"
...
#  as the billing address for ACH payments.
    ...
    # @param organization [Monite::PurchaseOrderCounterpartOrganizationResponse] 
...
#  person).
    ...
    # @return [Monite::PurchaseOrderCounterpartOrganizationRootResponse]
...
#  PurchaseOrderCounterpartOrganizationRootResponse
  ...
  nil
      ...
      unless parsed_json["organization"].nil?
        ...
        organization = Monite::PurchaseOrderCounterpartOrganizationResponse.from_json(json_object: organization)
      else
        organization = nil
      end
...
# Serialize an instance of PurchaseOrderCounterpartOrganizationRootResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Monite::PurchaseOrderCounterpartOrganizationResponse.validate_raw(obj: obj.organization)

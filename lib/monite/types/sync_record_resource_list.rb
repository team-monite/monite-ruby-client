...
require_relative "sync_record_resource"
require "ostruct"
require "json"

module Monite
  class SyncRecordResourceList
  # @return [Array<Monite::SyncRecordResource>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::SyncRecordResource>] 
...
# Deserialize a JSON object to an instance of SyncRecordResourceList
    #
  ...
  item = item.to_json
  Monite::SyncRecordResource.from_json(json_object: item)
end
...
# Serialize an instance of SyncRecordResourceList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

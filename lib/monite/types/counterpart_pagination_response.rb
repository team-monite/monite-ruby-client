...
require_relative "counterpart_response"
require "ostruct"
require "json"

module Monite
# A paginated list of counterparts
  class CounterpartPaginationResponse
  # @return [Array<Monite::CounterpartResponse>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::CounterpartResponse>] 
...
# Deserialize a JSON object to an instance of CounterpartPaginationResponse
    #
  ...
  item = item.to_json
  Monite::CounterpartResponse.from_json(json_object: item)
end
...
# Serialize an instance of CounterpartPaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

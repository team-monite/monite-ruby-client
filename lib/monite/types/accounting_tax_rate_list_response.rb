...
require_relative "accounting_tax_rate_response"
require "ostruct"
require "json"

module Monite
  class AccountingTaxRateListResponse
  # @return [Array<Monite::AccountingTaxRateResponse>] 
    attr_reader :data
  # @return [String] 
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::AccountingTaxRateResponse>] 
...
# Deserialize a JSON object to an instance of AccountingTaxRateListResponse
    #
  ...
  item = item.to_json
  Monite::AccountingTaxRateResponse.from_json(json_object: item)
end
...
# Serialize an instance of AccountingTaxRateListResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

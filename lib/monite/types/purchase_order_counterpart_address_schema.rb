...
module Monite
# Address information.
  class PurchaseOrderCounterpartAddressSchema
...
#  alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
    ...
    # @return [Monite::PurchaseOrderCounterpartAddressSchema]
...
# Serialize an instance of PurchaseOrderCounterpartAddressSchema to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
module Monite
  class OwnershipDeclarationInput
...
#  origin or the `X-Forwarded-For` request header.
    ...
    # @return [Monite::OwnershipDeclarationInput]
...
# Deserialize a JSON object to an instance of OwnershipDeclarationInput
    #
...
# Serialize an instance of OwnershipDeclarationInput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

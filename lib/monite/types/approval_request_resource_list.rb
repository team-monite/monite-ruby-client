...
require_relative "approval_request_resource_with_metadata"
require "ostruct"
require "json"

module Monite
  class ApprovalRequestResourceList
  # @return [Array<Monite::ApprovalRequestResourceWithMetadata>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::ApprovalRequestResourceWithMetadata>] 
...
# Deserialize a JSON object to an instance of ApprovalRequestResourceList
    #
  ...
  item = item.to_json
  Monite::ApprovalRequestResourceWithMetadata.from_json(json_object: item)
end
...
# Serialize an instance of ApprovalRequestResourceList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
require_relative "payment_record_response"
require "ostruct"
require "json"

module Monite
  class PaymentRecordResponseList
  # @return [Array<Monite::PaymentRecordResponse>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::PaymentRecordResponse>] 
...
# Deserialize a JSON object to an instance of PaymentRecordResponseList
    #
  ...
  item = item.to_json
  Monite::PaymentRecordResponse.from_json(json_object: item)
end
...
# Serialize an instance of PaymentRecordResponseList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

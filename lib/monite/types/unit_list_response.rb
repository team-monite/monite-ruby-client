...
module Monite
  ...
  # @return [Array<Monite::UnitResponse>] 
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::UnitResponse>] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Monite::UnitListResponse]
    def initialize(data:, additional_properties: nil)
      @data = data
      @additional_properties = additional_properties
      @_field_set = { "data": data }
    end
# Deserialize a JSON object to an instance of UnitListResponse
    #
  ...
  item = item.to_json
  Monite::UnitResponse.from_json(json_object: item)
end
      new(data: data, additional_properties: struct)
    end
# Serialize an instance of UnitListResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

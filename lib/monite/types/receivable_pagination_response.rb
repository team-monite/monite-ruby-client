...
require_relative "receivable_response"
require "ostruct"
require "json"

module Monite
# A paginated list of receivables
  class ReceivablePaginationResponse
  # @return [Array<Monite::ReceivableResponse>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::ReceivableResponse>] 
...
# Deserialize a JSON object to an instance of ReceivablePaginationResponse
    #
  ...
  item = item.to_json
  Monite::ReceivableResponse.from_json(json_object: item)
end
...
# Serialize an instance of ReceivablePaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

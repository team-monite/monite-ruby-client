...
require_relative "payable_response_schema"
require "ostruct"
require "json"

module Monite
# A paginated list of payables.
  class PayablePaginationResponse
  # @return [Array<Monite::PayableResponseSchema>] 
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::PayableResponseSchema>] 
...
# Deserialize a JSON object to an instance of PayablePaginationResponse
    #
  ...
  item = item.to_json
  Monite::PayableResponseSchema.from_json(json_object: item)
end
...
# Serialize an instance of PayablePaginationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

...
require_relative "event_resource"
require "ostruct"
require "json"

module Monite
  class EventPaginationResource
  # @return [Array<Monite::EventResource>] A set of events returned per page
    attr_reader :data
...
#  reached the first page).
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::EventResource>] A set of events returned per page
...
#  reached the first page).
    ...
    # @return [Monite::EventPaginationResource]
...
# Deserialize a JSON object to an instance of EventPaginationResource
    #
  ...
  item = item.to_json
  Monite::EventResource.from_json(json_object: item)
end
...
# Serialize an instance of EventPaginationResource to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

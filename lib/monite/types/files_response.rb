...
module Monite
  class FilesResponse
  # @return [Array<Monite::FileResponse>] 
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::FileResponse>] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Monite::FilesResponse]
    def initialize(data:, additional_properties: nil)
      @data = data
      @additional_properties = additional_properties
      @_field_set = { "data": data }
    end
# Deserialize a JSON object to an instance of FilesResponse
    #
  ...
  item = item.to_json
  Monite::FileResponse.from_json(json_object: item)
end
      new(data: data, additional_properties: struct)
    end
# Serialize an instance of FilesResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

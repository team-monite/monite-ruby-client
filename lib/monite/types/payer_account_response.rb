...
# Deserialize a JSON object to an instance of PayerAccountResponse
    #
...
# Serialize an instance of PayerAccountResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

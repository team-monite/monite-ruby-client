...
require_relative "ledger_account_response"
require "ostruct"
require "json"

module Monite
# A paginated list of ledger accounts.
  class LedgerAccountListResponse
  # @return [Array<Monite::LedgerAccountResponse>] 
    attr_reader :data
  # @return [String] 
  ...
  # @return [Object] 
    ...
    # @param data [Array<Monite::LedgerAccountResponse>] 
...
# Deserialize a JSON object to an instance of LedgerAccountListResponse
    #
  ...
  item = item.to_json
  Monite::LedgerAccountResponse.from_json(json_object: item)
end
...
# Serialize an instance of LedgerAccountListResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json

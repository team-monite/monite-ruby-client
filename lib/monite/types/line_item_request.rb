...
#  $12.50 is represented as 1250.
    ...
    # @return [Monite::LineItemRequest]
    def initialize(accounting_tax_rate_id: OMIT, description: OMIT, ledger_account_id: OMIT, name: OMIT, quantity: OMIT, tax: OMIT, unit: OMIT, unit_price: OMIT, additional_properties: nil)
      ...
      @_field_set = { "accounting_tax_rate_id": accounting_tax_rate_id, "description": description, "ledger_account_id": ledger_account_id, "name": name, "quantity": quantity, "tax": tax, "unit": unit, "unit_price": unit_price }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of LineItemRequest
    #
...
# Serialize an instance of LineItemRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
